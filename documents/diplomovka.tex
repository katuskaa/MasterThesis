...
%Vysvetlit reasoning, ako suvisi s algoritmom, co je cielom algoritmu, opisat ako priblizne funguje, povedat preco je spravny, pripadne dokaz
%Reasoning in description logic is very important. POVEDAT, CO JE CONSISTENCY, SATISFIABILITY. correct algorithm if -> sound complete, always terminates
...
%Concept satisfiability - priebeh algoritmu
 
%\begin{example}
%	example with knowledge base a postupnym priebehom vytvarania stromu	
%\end{example}

%Algorithm that proves satisfiability is called \textbf{DL Tableau algorithm}. Its intension is to create a tree where 
