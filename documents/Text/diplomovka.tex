...
In this chapter we would like to introduce two ways of abductive reasoning which we have implemented. The first one is ABox abduction algorithm and the second one is MergeXPlain. Our both approaches are using reasoners for consistency checking.
